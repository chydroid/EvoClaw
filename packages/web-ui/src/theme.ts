...
export const THEME_CRIMSON_DARK: ThemeColors = {
  bgPrimary: "#0d0d0d",
  bgSecondary: "#1a1a1a",
  bgTertiary: "#2a2a2a",
  bgCard: "#1a1a1a",
  ...
  headerBg: "#111111",
  tabBg: "#1a1a1a",
  userBubbleBg: "rgba(89, 25, 21, 0.7)",
  botBubbleBg: "rgba(25, 21, 21, 0.7)",
  userBubbleBorder: "rgba(10, 5, 5, 0.3)",
  botBubbleBorder: "rgba(196, 30, 58, 0.3)",
  msgNameColor: "#e05a72",
  sectionTitleColor: "#c41e3a",
  inputBorder: "#3d3d3d",

...
export class AuthProvider {
  ...
  async authenticate(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    if (req.path.startsWith("/api/skills/") || req.path.startsWith("/api/config/") || req.path.startsWith("/api/bootstrap/") || req.path.startsWith("/api/events") || req.path.startsWith("/api/permission-relay/") || req.path.startsWith("/api/crestodian/") || req.path.startsWith("/api/sessions/") || req.path.startsWith("/api/evolution/") || req.path.startsWith("/api/compactions") || req.path.startsWith("/api/scheduler/") || req.path.startsWith("/api/system/") || req.path.startsWith("/api/channels/") || req.path.startsWith("/api/plugins") || req.path.startsWith("/api/permission/") || req.path.startsWith("/api/retention/") || req.path.startsWith("/api/health/") || req.path.startsWith("/api/secrets/") || req.path.startsWith("/api/models/") || req.path.startsWith("/api/dead-letter-queue/") || req.path.startsWith("/api/message-templates") || req.path.startsWith("/api/reply-refs")) {
      return next();
    }

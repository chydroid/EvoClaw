...
keywords:
  ...
  - design
license: AGPL-3.0
homepage: https://github.com/isjiamu/gzh-design-skill
triggers:
  - type: keyword
    pattern: "公众号排版|gzh|微信排版|公众号文章|公众号"
    description: 当用户进行公众号文章排版时触发
  - type: intent
    pattern: "自动排版|一键排版|生成主题|自定义风格"
    description: 公众号排版或主题生成意图
metadata:
  openclaw:
    emoji: "📰"
    always: false
